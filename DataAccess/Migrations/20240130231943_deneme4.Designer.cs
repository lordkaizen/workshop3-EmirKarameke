...
namespace DataAccess.Migrations
{
    ...
    [Migration("20240130231943_deneme4")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Persons.CorporateCustomers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Persons.Customers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Persons.IndividualCustomers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<long>("NationIdentity")
            ...
            modelBuilder.Entity("Entities.Persons.Users", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Persons.CorporateCustomers", b =>
                {
                    b.HasOne("Entities.Persons.Customers", "Customers")
                        .WithMany()
                        .HasForeignKey("CustomersId");

                    b.HasOne("Entities.Persons.Users", "Users")
                        .WithMany()
